...
const HomePage = () => {
  ...
  useEffect(() => {
    // Simula o carregamento da página (substitua isto com seu próprio código de carregamento)
    setTimeout(() => {
      setIsLoading(false);
            ...
            <div className="single-cut" key={index}>
              ...
              <div className="cut-descriptions">
                <p>
                  ...
                  ligula mi lacinia libero, vehicula dui nisi eget purus.
                  Integer cursus nibh non risus maximus dictum. Suspendis.
                </p>
